...
#   
#   t <-rbind(t,temp)
#  write.csv(t,'allfiles-t.csv')

  # } 

# t<-read.csv('allfiles-t.csv')
```
...
# summaryforplot
# 
# write.csv(summaryforplot,'allfiles-summaryforplot.csv')

summaryforplot<- read.csv('allfiles-summaryforplot.csv')
