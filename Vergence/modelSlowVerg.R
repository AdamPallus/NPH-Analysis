...
MakeFigure(filter(z,time>37000,time<38500),zoom=FALSE)

MakeFigure(filter(z,time>39000,time<45000),zoom=FALSE)



MakeFigure(filter(z,time>660500,time<678000),zoom = FALSE)
