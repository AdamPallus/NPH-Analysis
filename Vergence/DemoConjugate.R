...
ggplot(d)+
  ...
  annotate('segment',x=468000,xend=468000,y=0,yend=50)+
  annotate('text',x=468000,y=45,label='100 spk/s')+
  annotate('segment',x=468000,xend=468000,y=100,yend=120)+
  annotate('text',x=468000,y=114,label='10 deg/s')+
  annotate('segment',x=468000,xend=468000,y=150,yend=175)+
  annotate('text',x=468000,y=170,label='5 deg')+
  annotate('segment',x=468000,xend=468100,y=75,yend=75)+
  annotate('text',x=468000,y=75,label='100 ms')+
  theme_minimal()+
  ylab('')
