...
#skip some of the initial analysis by loading a file with a data frame of partially measured data.
#The analysis code to create this saved file from the raw data is commented out below
 # t<- readRDS('INCsaccadesmarked.RDS')
 t<- readRDS('INCsaccadesmarkedBI.RDS') 

#note: I haven't fully tested whether the code chunks below actually will recreate this file

# t<-NULL
```

```{r quickload,echo=FALSE,cache=FALSE,cache.lazy=FALSE}
LoadFromFile<- TRUE
...
expandSaccades<- function(tt,buffer=80){
  ...
  #This way we can group_by(dsnum) to get juts the saccades
