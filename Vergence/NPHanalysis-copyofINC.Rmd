---
title: "Analysis of NPH in strabismus"
author: "Adam Pallus"
output:
...
zmc<- filter(zmc,!neuron %in% c('Bee-10','Bee-82','Bee-81','Bee-12'))
zm<- filter(zm,!neuron %in% c('Bee-10','Bee-82','Bee-81','Bee-12'))
...
```
```{r}
multiplot(ggplot(zm %>% filter(any.sig))+
