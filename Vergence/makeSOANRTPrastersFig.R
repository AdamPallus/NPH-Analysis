...
t<- filter(t,neuron %in% c('Bee-33','Bee-04','Bee-13','Bee-01'))
t<- filter(t,neuron %in% c('Bee-15','Bee-01'))
...
gs<-ggplot(gplot) + 
  ...
  geom_point(aes(counter,showrasters* snum*10+110),shape='|',size=1,color='black')+
...
ggsave('nrtprasters.PNG',height=20,width=8,plot=gs)
